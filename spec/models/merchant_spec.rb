...
RSpec.describe Merchant do
  ...
  it 'can order merchants by revenue' do
    ...
    # # invoice5 = create(:invoice, customer_id: customer.id, merchant_id: merchant1.id)
    ...
    # create(:invoice_item, item_id: item5.id, invoice_id: invoice1.id, quantity: 5, unit_price: 1.0)
